...
### Simulation
The documents `sim_nph_add.R` and [sim_ph_add.R] produce Table 1 of the main manuscript. The documents [sim_nph_multi.r](https://github.com/YZhang469/UPenn-RRMSTLM/blob/main/simulation/sim_nph_multi.r) and [sim_ph_multi.r](https://github.com/YZhang469/UPenn-RRMSTLM/blob/main/simulation/sim_ph_multi.r) produce Table 2.
